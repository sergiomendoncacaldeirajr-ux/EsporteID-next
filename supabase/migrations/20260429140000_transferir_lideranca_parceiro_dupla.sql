-- Permite transferir liderança para o outro jogador da dupla registrada em `duplas` (mesmo esporte),
-- mesmo sem linha em membros_time. Garante linhas em membros_time para ambos após a troca.
