-- Ranking: pendências e limite mensal por perfil (individual = atleta; dupla/time = formação).
-- Idempotente com 202605051230 se já contiver o mesmo corpo.
    ...
    select
      ...
      case
        ...
        then
          ...
          || ' (líder) enviou um desafio de ranking para outra formação. O pedido está pendente — evitem sugerir outro adversário até a resposta.'
        else
          'O líder enviou um desafio de ranking para outra formação. O pedido está pendente — evitem sugerir outro adversário até a resposta.'
      end,
      'match',
      v_mid,
      false,
