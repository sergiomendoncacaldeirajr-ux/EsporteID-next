-- Aceite de desafio (dupla/time): notificar elenco do time desafiante e do desafiado;
-- ranking e amistoso. Membros do time desafiado já tinham notificação só em ranking.
...
begin
  ...
  into v_usuario, v_status, v_adv, v_fin, v_adv_time_id, v_desafiante_time_id
