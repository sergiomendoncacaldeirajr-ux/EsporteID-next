-- Radar formações: `times.tipo` vazio/NULL deve equivaler a "time" (mesma convenção do app: tipo ?? 'time').
-- Antes, `'' = 'time'` na WHERE excluía todos os times sem tipo preenchido.
