...
export const DESAFIO_FLOW_CTA_CLASS =
  "eid-btn-dashboard-cta eid-profile-match-cta relative inline-flex min-h-[44px] items-center justify-center gap-2.5 !px-4 !text-[12px] font-extrabold uppercase tracking-[0.04em] disabled:pointer-events-none disabled:opacity-50";
...
export const DESAFIO_FLOW_SECONDARY_CLASS =
  "eid-btn-ghost inline-flex min-h-[44px] items-center justify-center px-4 text-[12px] font-extrabold uppercase tracking-[0.04em]";
...
export const DESAFIO_CHOICE_ACTION =
  "inline-flex min-h-[44px] w-full items-center justify-center rounded-xl border border-eid-action-500/40 bg-eid-action-500/12 px-4 text-center text-[12px] font-extrabold uppercase tracking-[0.04em] text-eid-action-200 transition hover:bg-eid-action-500/20";

/** Container do fluxo /desafio no app logado: folga extra acima do footer + nav inferior. */
export const DESAFIO_PAGE_MAIN_CLASS =
  "eid-touch-ui-scope mx-auto w-full max-w-3xl px-3 py-3 pb-[calc(var(--eid-shell-footer-offset)+2.5rem)] sm:px-6 sm:py-4 sm:pb-12";
