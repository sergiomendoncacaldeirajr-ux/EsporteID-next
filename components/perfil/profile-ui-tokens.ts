...
export const PROFILE_PUBLIC_MAIN_CLASS =
  "mx-auto w-full max-w-lg px-2.5 pb-[calc(var(--eid-shell-footer-offset)+3.25rem)] pt-0 sm:max-w-2xl sm:px-5 sm:pb-[calc(var(--eid-shell-footer-offset)+2.75rem)] sm:pt-2.5";

/** Landing de espaço: mesma base + largura maior no desktop. */
export const PROFILE_PUBLIC_MAIN_WIDE_CLASS =
  "mx-auto w-full max-w-lg px-2.5 pb-[calc(var(--eid-shell-footer-offset)+3.25rem)] pt-0 sm:max-w-2xl sm:px-5 sm:pb-[calc(var(--eid-shell-footer-offset)+2.75rem)] sm:pt-2.5 lg:max-w-6xl";
