    ...
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-[90]">
          ...
          />
          <aside
            className={`absolute inset-y-0 right-0 w-full max-w-[min(100vw,460px)] border-l border-[color:var(--eid-border-subtle)] bg-eid-bg shadow-[0_0_0_1px_rgba(148,163,184,0.12),-20px_0_40px_-20px_rgba(2,6,23,0.8)] transition-transform duration-200 ease-out ${
