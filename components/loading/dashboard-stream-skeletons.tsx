...
/** Placeholder da seção “Confrontos próximos” (grade 3 colunas). */
export function DashboardStreamConfrontosProximosSkeleton() {
  return (
...
/** Placeholder da seção “Vagas para equipes” (carrossel horizontal). */
export function DashboardStreamVagasEquipesSkeleton() {
  return (
    <section className={`${dashboardSectionOuter} mt-6 sm:mt-8`} aria-hidden>
      <div className={dashboardSectionHead}>
...
/** Fallback combinado (ex.: referências antigas). */
