...
export function MatchPageShell({ children, fullBleed = false }: { children: ReactNode; fullBleed?: boolean }) {
  return (
    <div className="relative z-0 flex w-full min-w-0 flex-1 flex-col" data-eid-match-page>
