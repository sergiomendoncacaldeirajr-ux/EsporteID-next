...
import { PROFILE_PUBLIC_AVATAR_RING_CLASS, PROFILE_PUBLIC_FORMACAO_ESCUDO_CLASS } from "@/components/perfil/profile-ui-tokens";
    ...
    >
      ...
      {!isFullView && !hideHero ? (
        <MatchRadarGridHero
          ...
          onAmistosoStateChange={setAmistosoLigado}
        />
      ) : null}
