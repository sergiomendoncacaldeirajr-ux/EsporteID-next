    ...
    <>
      ...
      <nav className="pointer-events-auto w-full bg-transparent" aria-label="Navegação principal">
        <div
          ...
          style={{
            minHeight: "calc(3.72rem + max(10px, env(safe-area-inset-bottom, 0px)))",
            paddingBottom: "calc(max(10px, env(safe-area-inset-bottom, 0px)) + 0.34rem)",
            ...
            {items.map((item) => {
              if (item.rank) {
                return (
                  ...
                  >
                    <span
                      className="pointer-events-none absolute -top-5 left-1/2 h-11 w-11 -translate-x-1/2 rounded-full blur-xl"
                      style={{
                    ...
                    />
                    <span
                      className={`absolute -top-[1.48rem] flex h-[44px] w-[44px] items-center justify-center rounded-full transition-all ${
                        item.active
                    ...
                    <span className="h-[20px] w-[32px]" aria-hidden />
                    <span
              ...
              return (
                ...
                >
                  <span
                    className={`relative flex h-[23px] w-[32px] items-center justify-center rounded-xl transition-all ${
                  ...
                  <span
                    className="text-[7px] font-medium leading-none transition"
                    style={{ color: item.active ? "var(--eid-fg)" : "var(--eid-text-secondary)" }}
                  >
                    {item.label}
                  </span>
