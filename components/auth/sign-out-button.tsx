  ...
  if (variant === "icon") {
    return (
      <button
        ...
        className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-[color:color-mix(in_srgb,var(--eid-danger-500)_38%,var(--eid-border-subtle))] bg-[color:color-mix(in_srgb,var(--eid-danger-500)_10%,var(--eid-card)_90%)] p-0 text-[color:color-mix(in_srgb,var(--eid-danger-400)_92%,var(--eid-fg)_8%)] shadow-sm transition-all duration-200 ease-out hover:border-[color:color-mix(in_srgb,var(--eid-danger-500)_55%,transparent)] hover:bg-[color:color-mix(in_srgb,var(--eid-danger-500)_15%,var(--eid-card)_85%)] hover:text-[color:color-mix(in_srgb,var(--eid-danger-400)_98%,var(--eid-fg)_2%)] active:translate-y-[0.5px] active:scale-[0.985] focus:outline-none focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_srgb,var(--eid-danger-500)_45%,transparent)]"
      >
        <IconPower />
      </button>
    );
