  ...
  if (variant === "icon") {
    ...
    return (
      ...
      <button
        ...
        className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-[color:var(--eid-border-subtle)] bg-[linear-gradient(180deg,color-mix(in_srgb,var(--eid-card)_94%,transparent),color-mix(in_srgb,var(--eid-surface)_92%,transparent))] text-red-400/90 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_6px_14px_-12px_rgba(0,0,0,0.45)] transition-all duration-200 ease-out hover:border-red-400/40 hover:text-red-300 active:translate-y-[0.5px] active:scale-[0.985] focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400/40"
