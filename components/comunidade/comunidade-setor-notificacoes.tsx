      ...
      <div className="mt-3 flex flex-wrap gap-2">
        {items.length > INITIAL ? (
          <button
            ...
            className="rounded-lg border border-eid-primary-500/35 bg-eid-primary-500/8 px-3 py-1.5 text-[11px] font-bold uppercase tracking-wide text-eid-primary-300 transition hover:border-eid-primary-500/50"
          >
        ...
        <button
          ...
          className="rounded-lg border border-[color:var(--eid-border-subtle)] px-3 py-1.5 text-[11px] font-bold uppercase tracking-wide text-eid-text-secondary transition hover:border-red-400/40 hover:text-red-300 disabled:opacity-50"
        >
          {pending ? "…" : "Limpar"}
        </button>
      </div>
