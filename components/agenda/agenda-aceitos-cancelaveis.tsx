...
function WhatsAppContatoButton({ href, nome }: { href: string; nome: string | null | undefined }) {
  ...
  return (
    <a
      ...
      className="eid-agenda-compact-whatsapp inline-flex min-h-[24px] min-w-0 max-w-[min(9.5rem,100%)] items-center gap-1 rounded-full bg-[#25D366] px-2 text-[7px] font-black text-white shadow-[0_3px_14px_-6px_rgba(37,211,102,0.65)] transition hover:bg-[#1fbb5a] active:scale-[0.97] md:min-h-[26px] md:text-[8px]"
    >
