            ...
            {m.whatsappContato ? (
              <div className="mt-2 md:mt-2.5">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full border border-[#25D366]/40 bg-[#25D366]/10 px-2.5 py-1 text-[10px] font-bold text-[#25D366] shadow-[0_1px_6px_-3px_rgba(37,211,102,0.25)] transition hover:bg-[#25D366]/18 active:scale-[0.97] md:text-[11px]"
                  aria-label={`Chamar ${m.whatsappContatoNome ? m.whatsappContatoNome.split(" ")[0] : "no WhatsApp"} no WhatsApp`}
                >
                  {/* WhatsApp icon */}
                  <svg viewBox="0 0 24 24" className="h-3 w-3 shrink-0 md:h-3.5 md:w-3.5" fill="currentColor" aria-hidden>
