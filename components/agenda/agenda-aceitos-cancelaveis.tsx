...
function WhatsAppContatoButton({ href, nome }: { href: string; nome: string | null | undefined }) {
  ...
  return (
    <a
      ...
      className="flex min-h-[48px] w-full items-center justify-center gap-2 rounded-2xl bg-[#25D366] px-3 text-[11px] font-black uppercase tracking-[0.05em] text-white shadow-[0_6px_18px_-8px_rgba(37,211,102,0.55)] transition hover:bg-[#1fbb5a] active:scale-[0.98] active:brightness-95 sm:text-[12px]"
    >
      {WA_ICON}
