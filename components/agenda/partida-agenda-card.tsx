      ...
      {cancelMatchId && !isPlacar && !desistMatchId ? (
        <>
          ...
          <button
            ...
            className="absolute left-1/2 top-2.5 z-[3] inline-flex min-h-[22px] items-center justify-center rounded-lg border border-red-600/90 bg-red-600 px-2 text-[8px] font-black uppercase tracking-[0.05em] text-white shadow-[0_4px_14px_-4px_rgba(220,38,38,0.45)] transition hover:bg-red-700 active:scale-[0.98]"
