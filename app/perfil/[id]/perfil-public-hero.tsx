      ...
      <div id="perfil-hero-cover" className="relative h-[6.75rem] w-full sm:h-[7.75rem]">
        ...
        {isSelf ? (
          <ProfileEditDrawerTrigger
            ...
            fullscreen
            topMode="backOnly"
            className="eid-profile-compact-action absolute -bottom-[22px] right-2 z-[4] inline-flex items-center justify-center gap-1 rounded-full border border-[color:var(--eid-border-subtle)] bg-eid-surface/70 px-2.5 py-1 text-[8px] font-bold uppercase leading-none tracking-[0.08em] text-eid-text-secondary shadow-[0_3px_10px_-7px_rgba(2,6,23,0.6)] transition-all hover:border-eid-primary-500/35 hover:bg-eid-primary-500/10 hover:text-eid-fg"
          >
          ...
          <div className="min-w-0 pl-[calc(68px+0.75rem)] pt-6 pb-1 sm:pt-8">
            ...
            {perfil.username || perfil.localizacao ? (
              <div className="mt-1.5 flex flex-wrap items-center gap-1.5 text-[10px]">
                ...
                {perfil.localizacao ? (
                  <div className="overflow-hidden rounded-lg border border-[rgba(37,99,235,0.16)] bg-[color:color-mix(in_srgb,var(--eid-primary-500)_8%,var(--eid-surface)_92%)] px-1.5 py-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
