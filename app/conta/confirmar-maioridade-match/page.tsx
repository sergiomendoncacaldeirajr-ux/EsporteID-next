...
export const metadata = {
  title: "Confirmação etária — Match",
  description: "Confirme que tem 18 anos ou mais para usar o sistema de match.",
};
...
export default async function ConfirmarMaioridadeMatchPage({ searchParams }: Props) {
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-10">
      <h1 className="text-xl font-bold text-eid-fg">Uso do Match — maioridade</h1>
      <p className="mt-3 text-sm leading-relaxed text-eid-text-secondary">
        A função <strong className="text-eid-fg">Match</strong> é destinada exclusivamente a pessoas{" "}
